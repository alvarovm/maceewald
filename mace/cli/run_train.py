...
print(f"my_module imported from: {modules.__file__}")
...
def run(args: argparse.Namespace) -> None:
    ...
    elif args.model == "MACE_Ewald":
        print("im in MACE_Ewald block within args.model")
        # ewald_params = args.ewald_hyperparams
